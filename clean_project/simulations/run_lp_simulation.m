function results = run_lp_simulation(config, BatteryQueue, PV_profile)
%RUN_LP_SIMULATION Swap-station simulation using a linear-programming policy.
%   results = RUN_LP_SIMULATION(config, BatteryQueue, PV_profile) simulates
%   the station using an LP-based charging policy, for comparison against
%   the MPC, AMCCCV, and baseline simulations.
%
%   Inputs:
